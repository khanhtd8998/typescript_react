...
const Header = () => {
  ...
  useEffect(() => {
    ...
    (localStorageData) ? setUserData(JSON.parse(localStorageData)) : null
  }, []);
    ...
    <>
      <nav className='navbar navbar-expand-lg navbar-light bg-light'>
        <div className='container-fluid'>
          ...
          <div className='container-fluid m-0 p-0 ps-5 d-flex justify-content-end'>
            {/* <marquee className='d-flex align-items-center' behavior="scroll" direction="left">
              <p className="m-0 p-0">  {formatDate(currentDateTime)} {currentDateTime.toLocaleTimeString()}</p>
            </marquee> */}
            {userData && (
              <nav className="navbar navbar-expand-lg navbar-light bg-light tw-mr-[8rem]">
                <div className="container-fluid">
                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                      <li className="nav-item dropdown">
                        <NavLink
                          ...
                          aria-expanded="false"
                        >
                          Hi, <strong>{(userData?.user.username).toUpperCase()}</strong>
                        </NavLink>
